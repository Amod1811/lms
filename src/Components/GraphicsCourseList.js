          ...
          <div className="d-flex">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb breadcrumb-dark breadcrumb-dots mb-0">
                ...
                <li className="breadcrumb-item active" aria-current="page">Graphics Design</li>
              </ol>
            </nav>
          </div> 
        </div>
              ...
              <div className="col-md-8">
                <div className="card-body">
                  ...
                  <div className="d-flex justify-content-between mb-2">
                    <h5 className="card-title mb-0 mt-5" ><a href="#">Canva</a></h5>
                    {/* Wishlist icon */}
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  {/* Title */}
                  <div className="d-flex justify-content-between mb-2">
                    <h5 className="card-title mb-0"><a href="#">PosterMyWall</a></h5>
                    {/* Wishlist icon */}
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  {/* Title */}
                  <div className="d-flex justify-content-between mb-2">
                    <h5 className="card-title mb-0"><a href="#">RenderForest</a></h5>
                    {/* Wishlist icon */}
                    <a href="#" className="h6 fw-light"><i className="far fa-heart" /></a>
                  </div>
                  {/* Content */}
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  {/* Title */}
                  <div className="d-flex justify-content-between mb-2">
                    <h5 className="card-title mb-0"><a href="#">Figma</a></h5>
                    {/* Wishlist icon */}
                    <a href="#"><i className="fas fa-heart text-danger" /></a>
                  </div>
                  {/* Content */}
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  {/* Title */}
                  <div className="d-flex justify-content-between mb-2">
                    <h5 className="card-title mb-0"><a href="#">Adobe Express</a></h5>
                    {/* Wishlist icon */}
                    <a href="#" className="h6 fw-light"><i className="far fa-heart" /></a>
                  </div>
                  {/* Content */}
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  {/* Title */}
                  <div className="d-flex justify-content-between mb-2">
                    <h5 className="card-title mb-0"><a href="#">KineMaster</a></h5>
                    {/* Wishlist icon */}
                    <a href="#" className="h6 fw-light"><i className="far fa-heart" /></a>
                  </div>
                  {/* Content */}
