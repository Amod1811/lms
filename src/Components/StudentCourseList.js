            ...
            <div className="offcanvas-body p-3 p-xl-0">
              <div className="bg-dark border rounded-3 p-3 w-100">
                ...
                <div className="list-group list-group-dark list-group-borderless collapse-list">
                  ...
                  <a className="list-group-item" href="student-course-resume.html"><i className="far fa-fw fa-file-alt me-2" />Course Resume</a>
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><a href="#">The Complete Web Development in python</a></h6>
                            {/* Info */}
                            <div className="overflow-hidden">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><a href="#">Digital Marketing Masterclass</a></h6>
                            {/* Info */}
                            <div className="overflow-hidden">
                    ...
                    <tr>
                      ...
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="mb-0 ms-2">
                            {/* Title */}
                            <h6 className="table-responsive-title"><a href="#">Graphic Design Masterclass</a></h6>
                            {/* Info */}
                            <div className="overflow-hidden">
