    ...
    <div className="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabIndex={-1} id="offcanvasSidebar">
      <div className="offcanvas-body sidebar-content d-flex flex-column bg-dark">
        ...
        <ul className="navbar-nav flex-column" id="navbar-sidebar">
          ...
          {/* Menu item 8 */}
          <li className="nav-item">
            <a className="nav-link" data-bs-toggle="collapse" href="#collapseauthentication" role="button" aria-expanded="true" aria-controls="collapseauthentication">
              <i className="bi bi-lock fa-fw me-2" />Authentication
            </a>
            {/* Submenu */}
            <ul className="nav collapse flex-column show" id="collapseauthentication" data-bs-parent="#navbar-sidebar">
              ...
              <li className="nav-item"> <a className="nav-link active" href="error-404.html">Error 404</a></li>
            </ul>
          </li>
          {/* Title */}
