    ...
    <div className="offcanvas offcanvas-start flex-row custom-scrollbar h-100" data-bs-backdrop="true" tabIndex={-1} id="offcanvasSidebar">
      <div className="offcanvas-body sidebar-content d-flex flex-column bg-dark">
        ...
        <ul className="navbar-nav flex-column" id="navbar-sidebar">
          ...
          {/* Menu item 6 */}
          <li className="nav-item"> <a className="nav-link active" href="admin-earning.html"><i className="far fa-chart-bar fa-fw me-2" />Earnings</a></li>
          {/* Menu item 7 */}
        ...
        <div className="px-3 mt-auto">
          <div className="d-flex align-items-center justify-content-between">
            <a className="h5 mb-0 text-primary-hover" href="admin-setting.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Setting">
              <i className="bi bi-gear-fill" />
            </a>
            <a className="h5 mb-0 text-primary-hover" href="index-2.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Home">
              <i className="bi bi-globe" />
            </a>
            <a className="h5 mb-0 text-primary-hover" href="sign-in.html" data-bs-toggle="tooltip" data-bs-placement="top" title="Sign up">
